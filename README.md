...
python -m pytest -q -p no:cacheprovider   # 248 pruebas de aceptación, sin red
...
- **Backtest con pronosticadores** (`twlab/backtest.py`, `twlab/models/q1.py`): recorrido semanal con Q0 (momentum), Q1 (ridge + LightGBM sobre rangos de rentabilidad semanal, entrenado sólo con etiquetas conocidas al corte, reentrenado cada 4 semanas) y A1 (aleatorio emparejado). Sobre la muestra 2024-2025 (informe 14) Q1 supera a A1 en +0,15 % semanal neto con IC 95 % [−0,24 %, +0,47 %]: no distinguible de cero, y los costes ilustrativos dejan a los tres en negativo.

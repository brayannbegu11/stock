...
- **Universo completo con la fuente oficial por fecha** (`twlab/sources/twse_daily.py`, informe 15): 1.937 acciones, mayo-septiembre 2026 (17 semanas operadas, 1 pendiente), Q0/Q1/A1 **sin dividendos** (la fuente no los trae). Con 17 semanas el exceso emparejado es degenerado (no estimable); el resultado útil es operativo: el nocional de 1 M TWD por puesto no puede comprar un lote de los valores que cotizan por encima de 1.000 TWD (16 entradas fallidas de Q1), y esa decisión de protocolo pesa más que el modelo.

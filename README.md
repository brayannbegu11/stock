...
- Decisions that belong to the author are listed in `docs/informes/01_entendimiento_bloqueantes_y_plan.md` §4.2, `docs/informes/11_demo_q0_2024-2025.md` §4 and `docs/informes/21_respuesta_ronda15_astra.md` §4. Last Astra round answered: 19 (report 25; rounds 18 and 19 ended in “approved with changes”, with medium and low findings only). The two universe scenarios are being regenerated with the round 19 fix for pending-week costs; until that finishes, the published JSONs lack the costs of week 2026-W37 only.

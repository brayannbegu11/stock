...
python -m pytest -q -p no:cacheprovider   # 258 pruebas de aceptación, sin red
...
```powershell
.\review\run_astra.ps1 -Ronda ronda11_verificacion -Effort high
```
...
- Los bloqueantes que requieren decisión del usuario están en `docs/informes/01_entendimiento_bloqueantes_y_plan.md` §4.2, `docs/informes/11_demo_q0_2024-2025.md` §4 y `docs/informes/16_respuesta_ronda10_astra.md` §4. Última ronda de Astra respondida: 10 (informe 16); 258 pruebas incluyen sus contraejemplos.

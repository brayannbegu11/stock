...
python -m pytest -q -p no:cacheprovider   # 244 pruebas de aceptación, sin red
...
```powershell
.\review\run_astra.ps1 -Ronda ronda10_verificacion -Effort high
```
...
- Los bloqueantes que requieren decisión del usuario están en `docs/informes/01_entendimiento_bloqueantes_y_plan.md` §4.2, `docs/informes/11_demo_q0_2024-2025.md` §4 y `docs/informes/13_respuesta_ronda9_astra.md` §4.

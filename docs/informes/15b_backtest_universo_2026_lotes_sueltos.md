...
|---|---|---|---|---|---|---|
| Q0 (`rule:momentum_20_sessions_v1`) | -1.85 % | -0.08 % | +0.97 % | 5/17 | 49,623 TWD | -1.05 % [-6.40 %, +0.16 %] n=12 (variabilidad limitada: 4 semanas fijas) |
| Q1 (`q1:tabular_ridge_lgbm_rank_v2`) | -0.94 % | +0.30 % | +0.95 % | 6/17 | 60,057 TWD | -0.23 % [-1.44 %, +0.24 %] n=15 |
| A1 (`rule:random_eligible_v1`) | -1.08 % | +0.47 % | +0.96 % | 5/17 | 56,938 TWD | — |

...
**Qué es:** el primer recorrido del protocolo sobre **todas** las acciones ordinarias del tablero principal de TWSE y TPEx (1.937 valores del maestro, informe 10), con las cotizaciones oficiales diarias por fecha (`twlab/sources/twse_daily.py`: TWSE `MI_INDEX`, TPEx `dailyQuotes`, capturadas el 9 y 10 de septiembre de 2026 para las 540 sesiones desde julio de 2024). Periodo: cortes dominicales del 10 de mayo al 6 de septiembre de 2026 (18 semanas: 17 operadas y la semana en curso, pendiente de desenlace). Ni Astra (corte de conocimiento 30-04-2026) ni Fable (junio de 2026) conocen este periodo.

**Qué demuestra:** que la cadena completa (paquete → predicción validada → libro → emparejamiento) funciona sobre el universo real, con unas 835 acciones elegibles por semana; que gestiona un cierre sobrevenido real (viernes 10-07-2026: ninguna de las 1.937 acciones negoció; las salidas quedaron bloqueadas y se reintentaron la semana siguiente, y la semana 2026-W28 quedó fuera de la estadística); y que emite y archiva la lista de la semana en curso.

**Qué NO demuestra:** rentabilidad. Diecisiete semanas no bastan; la fuente no trae dividendos (mayo-septiembre es la temporada de reparto en Taiwán: los retornos están **sesgados a la baja**, sobre todo para valores de alto dividendo); el universo es el censo vigente (supervivencia); los costes son ilustrativos; y el exceso emparejado es **degenerado** (pocas semanas emparejables, porque las entradas fallidas de Q0 y Q1 dejan exposiciones muy distintas de las de A1): no hay intervalo de confianza que publicar.
...
| Entradas fallidas (lote más caro que el nocional) | 9 | 16 | 4 | — |
...
Lectura correcta: en un mercado que subió con fuerza (+1,2 % semanal el universo elegible), las dos reglas de precios lo hicieron peor que el azar, y el azar peor que el mercado. Con 17 semanas, sin dividendos y sin intervalo, esto **no** distingue mala suerte de mala señal. Lo que sí es un hecho operativo:

1. **El nocional de 1 M TWD por puesto no puede comprar un lote (1.000 acciones) de los valores que cotizan por encima de 1.000 TWD.** Q1 elige con frecuencia 台積電 (2330, ≈ 2.400 TWD), 鴻海, 緯穎: 16 entradas fallidas de 85. Hay que decidir: subir el nocional, admitir lotes menores (零股, adaptador pendiente) o filtrar el universo por precio ≤ nocional/1.000. Es una decisión de protocolo y cambia el universo elegible.
...
3. Los costes ilustrativos (≈ 0,75 % semanal sobre lo invertido) siguen siendo mayores que cualquier diferencia entre pronosticadores.

## Lista de la semana en curso (corte domingo 6-09-2026 18:00 Taipei; semana 2026-W37)

Emitida y archivada con hora real el 10-09-2026 en `data/raw` (`forecast/universe_2026-05-04_2026-09-09/<pronosticador>/2026-W37`), validada contra el contrato; entrada simulada en la apertura del lunes 7-09; salida prevista el viernes 11-09 (pendiente).
...
| Q1 tabular | 6669 緯穎 · 2330 台積電 · 3037 欣興 · 2317 鴻海 · 2412 中華電 | 2 de 5 ejecutadas; 3 sin lote posible (precio > nocional) |
...
- Sin dividendos: la fuente oficial por fecha no los trae; libro y etiquetas de Q1 operan sin derechos (FinMind, que sí los trae, limita a ~300 peticiones por hora en el nivel gratuito).
...
- 8.787 barras sin precio de sesión regular excluidas; 12 sesiones oficiales sin datos (cierres por tifón de 2024 y el 10-07-2026).

...
| R10-02 | alta | `TabularForecaster.maybe_train` rechaza cortes no crecientes (`ValueError`): una instancia sirve a un solo recorrido cronológico. | `test_r10_02_tabular_forecaster_rejects_non_increasing_cutoffs` |
